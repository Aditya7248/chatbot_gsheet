...
# Function to save chat to Google Sheet
def save_to_google_sheet(user_message, bot_response):
    # Path to the service account JSON file
    scope = ["https://spreadsheets.google.com/feeds", 'https://www.googleapis.com/auth/spreadsheets',
             "https://www.googleapis.com/auth/drive.file", "https://www.googleapis.com/auth/drive"]
    creds = ServiceAccountCredentials.from_json_keyfile_name("my-chatbot-project-429606-68ac238acf14.json", scope)  
    client = gspread.authorize(creds)
    sheet = client.open_by_key("11KP2UCeMIlkDnpeP1bvhntRuhnm7pnMNMHzRVc0SwUU").sheet1
...
def main():
    ...
    def handle_user_input():
        ...
        save_to_google_sheet(user_input, response)  # Save conversation to Google Sheet
...
# Sheet URL: https://docs.google.com/spreadsheets/d/11KP2UCeMIlkDnpeP1bvhntRuhnm7pnMNMHzRVc0SwUU/edit?gid=0#gid=0